...
namespace TargetProcess.Core.DependancyInjection
{
    public interface IIocContainer
    {
        ...
        void OverrideRegistration<TInterface, TConcrete>(LifeCycle lifeCycle, Func<TConcrete> initialization) where TConcrete : class;
        void Register();
        ...
        private object FetchObject(Type @interface)
        {
            ...
            if (registeredObject == null)
                throw new TypeNotRegisteredException(string.Format(
                    format: "The type {0} has not been registered", arg0: @interface.Name));
